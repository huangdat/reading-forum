...
public class SearchingController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.equals("/SearchingController")) {    
            String seacrh = (String) request.getAttribute("seacrh");
            System.out.println("1234"+seacrh);   
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        if (request.getAttribute("btnSearch")!=null  ) {
            String seacrh = (String) request.getAttribute("seacrh");
            System.out.println(""+request.getAttribute("seacrh"));
